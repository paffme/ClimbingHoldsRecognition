...
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs/default")
...
class ClimbingHoldConfig(Config):
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        assert args.dataset, "Argument --datase is required for training"
    ...
    # Configurations
    if args.command == "train":
        config = ClimbingHoldConfig()
    else:
        class InferenceConfig(ClimbingHoldConfig):
    ...
    if args.weights.lower() == "trained":
        weights_path = TRAINED_WEIGHT_PATH
